      ...
      <Card className="h-full flex flex-col justify-between">
        ...
        <CardContent className="space-y-3">
          ...
          <div className="grid grid-cols-2 gap-x-4 gap-y-2 text-sm">
            ...
            <div className="space-y-1">
              <p className="text-muted-foreground">Time Charged</p>
              <p className="font-medium">{formatTime(elapsedTime)}</p>
            </div>
            <div className="space-y-1">
              <p className="text-muted-foreground">Energy Added</p>
              <p className="font-medium">{energyAdded.toFixed(2)} kWh</p>
            </div>
            <div className="space-y-1">
              <p className="text-muted-foreground">Final Charge</p>
              <p className="font-medium">
                {Math.min(100, chargePercentage).toFixed(0)}%
              </p>
            </div>
          </div>
        </CardContent>
  ...
  return (
    <Card className="h-full flex flex-col justify-between">
      ...
      <CardContent className="flex flex-col items-center justify-center flex-grow py-0">
        ...
        />
        <p className="text-2xl font-bold mt-1 font-headline">
          {Math.min(100, chargePercentage).toFixed(0)}%
        </p>
        <Progress
          value={Math.min(100, chargePercentage)}
